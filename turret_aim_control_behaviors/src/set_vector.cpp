...
class SetVectorAction : public BT::SyncActionNode
{
public:
  SetVectorAction(const std::string name, const BT::NodeConfig &config)
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<geometry_msgs::msg::Vector3>("output_vector", "vector output port")
    };
  }
  ...
  BT::NodeStatus tick() override
  {
    ...
    setOutput<geometry_msgs::msg::Vector3>("output_vector", my_vector);
